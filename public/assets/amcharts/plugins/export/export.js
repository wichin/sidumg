...
if ( !AmCharts.translations[ "export" ][ "en" ] ) {
	AmCharts.translations[ "export" ][ "en" ] = {
		...
		"fallback.save.image": "Haga clic derecho -> Guardar imagen como ... para guardar la imagen.",

		"capturing.delayed.menu.label": "{{duration}}",
		"capturing.delayed.menu.title": "Haga clic para cancelar",
