        ...
        <div class="col m6 offset-m3 teal lighten-5">
            ...
            <form class="col s12" id="formLogin" method="POST" action="{{url('/login')}}">
                ...
                <div class="row" style="text-align: center">
                    <button class="btn waves-effect waves-light center submit blue darken-4" id="btnLogin" type="submit"><i class="fa fa-check-square" aria-hidden="true"></i> INGRESAR</button>
