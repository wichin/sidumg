...
@section('contenido')
    ...
    <form action="{{url('factura/crearCliente')}}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col s12 m4 l4 input-field">
                <input type="text" id="documento" name="documento" class="validate" required="" aria-required="true">
                <label for="documento">Documento</label>
            </div>
            <div class="col s12 m4 l4 input-field">
                <select id="tipoDocumento" name="tipoDocumento" class="validate" required="" aria-required="true">
                    <option value="" disabled selected>Seleccione...</option>
